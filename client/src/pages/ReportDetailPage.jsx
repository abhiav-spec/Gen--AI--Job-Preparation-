        ...
        <div className="max-w-[1200px] mx-auto w-full pt-12">
          ...
          <div className="flex items-center justify-between mb-8">
            <button 
              ...
              className="group flex items-center gap-2 text-[#94a3b8] hover:text-[#5de6ff] transition-colors font-space text-[10px] uppercase font-bold tracking-widest"
            >
            ...
            <div className="flex gap-3">
              <button className="p-3 rounded-xl glass-surface border border-[rgba(255,255,255,0.08)] text-[#94a3b8] hover:text-white transition-all">
                <Share2 size={18} />
              </button>
              <button 
                onClick={handleDownload}
                disabled={downloading}
                className="flex items-center gap-2 px-6 py-3 rounded-xl ai-gradient-bg text-[#0c0c1d] font-space font-bold uppercase tracking-widest text-[10px] hover:shadow-[0_0_20px_rgba(93,230,255,0.4)] transition-all disabled:opacity-50"
              >
