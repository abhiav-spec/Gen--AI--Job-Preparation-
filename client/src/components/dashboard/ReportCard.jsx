...
const ReportCard = ({ role, score, date, reportId, index, type = 'report' }) => {
  ...
  return (
    <motion.div
      ...
      className={`group flex flex-col md:flex-row items-center justify-between p-6 rounded-4xl transition-all hover:-translate-y-1 hover:shadow-[0_15px_30px_rgba(93,230,255,0.02)]
        ${isEven 
    ...
    >
      ...
      <div className="flex items-center gap-6 w-full md:w-1/2 mb-4 md:mb-0">
        <div className="w-14 h-14 rounded-2xl flex items-center justify-center bg-[rgba(192,193,255,0.05)] border border-[rgba(192,193,255,0.15)] group-hover:bg-[rgba(93,230,255,0.1)] transition-colors">
          {type === 'mock' ? (
            <Mic className="text-secondary group-hover:text-primary transition-all" size={24} />
          ) : (
            <FileText className="text-primary group-hover:text-secondary group-hover:drop-shadow-[0_0_8px_rgba(93,230,255,0.5)] transition-all" size={24} />
          )}
        </div>
      ...
      <div className="w-full md:w-1/4 flex flex-col items-center md:items-start px-4 mb-6 md:mb-0">
        <div className="flex justify-between w-full mb-2">
          <span className="font-space text-[10px] uppercase font-bold text-primary tracking-widest">Readiness</span>
          <span className="font-space font-bold text-secondary drop-shadow-[0_0_10px_rgba(93,230,255,0.3)]">{score}%</span>
        </div>
      ...
      <div className="w-full md:w-auto flex items-center justify-end gap-3">
        ...
        {type === 'report' && (
          <button 
            ...
            className="flex items-center justify-center p-3 rounded-xl glass-surface-low border border-outline-variant text-[#94a3b8] hover:text-secondary hover:border-[rgba(93,230,255,0.3)] transition-all disabled:opacity-50"
          >
        ...
        <button 
          ...
          className="flex items-center gap-2 px-5 py-3 rounded-xl bg-[rgba(192,193,255,0.08)] border border-[rgba(192,193,255,0.2)] text-primary font-inter font-semibold text-sm hover:bg-[rgba(192,193,255,0.15)] hover:text-white hover:border-[rgba(192,193,255,0.4)] transition-all group/btn"
        >
          Review Report
